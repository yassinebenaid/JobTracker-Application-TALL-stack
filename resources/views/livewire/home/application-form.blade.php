<div x-data='application' x-cloak x-show="open" x-on:status:success.window="hide"
    class="fixed top-0 left-0 grid w-screen h-screen bg-slate-500/30 place-content-center">

    <div x-on:click.outside="hide" x-cloak x-show="open" x-transition
        ...
        <div class="flex flex-col gap-5 p-5">
            ...
            <div>
                <x-input-label for="job" :value="__('Expected Salary')" />
                <x-text-input wire:model.defer='expected_salary' id="job" type="number"
            ...
            <div>
                ...
                <textarea wire:model.defer='cover' x-model="cover" id="cover"
        ...
        <div class="flex justify-end">
            <x-primary-button wire:click='save' x-bind:disabled="cover.length < 100"
